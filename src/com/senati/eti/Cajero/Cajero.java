...
public class Cajero {
	public static void main(String[] args) {
		...
		String contraseña="", rpta="Si",nntran="Andrea Gómez";
		...
		while (rpta.equals("Si")) {
			...
			if(clave==12345 && contraseña.equals("holamundo")) {
					while(!salir) {
						...
						System.out.println("---------------------------------");
						System.out.println("");
						System.out.println("Bienvenido Roberto Arenas");
						System.out.println("");
						...
						case 4:
			                System.out.print("Ingrese el valor que desea transferir: ");
			                    ...
			                    if (tran <= saldo_inicial ){
			                        ...
			                        ntran = sc.nextInt();
			                        if (ntran!=12346) {
				                    	System.out.println("Esta tarjeta no existe");
			                        }else {
			                        System.out.println("Ud realizo una transacción a la cuenta de:  "+nntran+" por valor de "+tran);
			                        }    
			                    }else{
